import { Button, Container, Flex, FormControl, FormErrorMessage, Input, Select, Switch, Text } from "@chakra-ui/react";
        ...
        >
          {({ values, touched, errors }) => (
            <Form>
              ...
              <FormControl
                isInvalid={!!errors.hold && touched.hold}
                my={4}
              >
                <Field
                  as={Switch}
              ...
              <FormControl
                my={4}
                isInvalid={!!errors.sides && touched.sides}
              >
                <Field
                  as={Select}
                  id="sides"
